...
public class EndActivity extends AppCompatActivity implements OnClickListener, DialogInterface.OnClickListener {
    ...
    public void init() {
        ...
        gamedb = new MyGamedb(EndActivity.this, "Scoredb.db", null, 1);
                ...
                if (firstcursor.moveToFirst()) {
                    do {
                        ...
                        if (myscore > temporaryscore) {
                            ...
                            values.clear();
                            values.put("name", "第二名：");
                            values.put("score", temporaryscore);
                            db.insert("myscoretable", null, values);
                            values.clear();
    ...
    public void showdata() {
        ...
        adapter = new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                LayoutInflater mInflater = LayoutInflater.from(EndActivity.this);
                if (convertView == null) {
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == -2) {
            ...
            Toast.makeText(EndActivity.this, "已取消", Toast.LENGTH_SHORT).show();
        }
    }
}